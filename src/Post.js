    ...
    <div className='post'>
      ...
      <div className='like_button'>
        {liked ? (<FontAwesomeIcon onClick={handleLike}
          icon={solidHeart} style={{ color: "#ed4956", padding: "8px", fontSize: "23px", cursor: "pointer" }} />) : (<FontAwesomeIcon
            icon={faHeart} onClick={handleLike} style={{ color: "#ed4956", padding: "8px", fontSize: "23px", cursor: "pointer" }} />)}
